...
const MetodoTravessiaHero = () => {
  return (
    <section className="relative w-full min-h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="hidden lg:block container max-w-6xl mx-auto px-8 py-16 relative z-10 w-full">
        ...
        <div className="grid grid-cols-2 gap-12 items-center">
          ...
          {/* Right column - Video */}
          <div className="relative mx-0 w-full max-w-xl">
            {/* Background shapes for video */}
        ...
        {/* Icon features grid - Desktop version */}
      ...
      {/* Mobile View - Hidden on desktop screens */}
      <div className="block lg:hidden container mx-auto px-5 pt-8 pb-12 relative z-10 flex flex-col items-center">
        {/* Logo centered at top with better spacing */}
        ...
        <div className="flex flex-col w-full items-center">
          ...
          <div className="relative w-full max-w-md mb-8">
            ...
            <div className="absolute -top-4 -right-4 w-full h-1/2 bg-gradient-to-bl from-[#AF8D4A]/25 to-transparent skew-x-12 blur-xl"></div>
            <div className="absolute -bottom-6 -left-6 w-3/4 h-1/2 bg-gradient-to-tr from-[#AF8D4A]/20 to-transparent rounded-tl-3xl blur-lg"></div>
            <div className="absolute top-1/2 left-0 w-12 h-24 bg-[#AF8D4A]/10 rounded-full blur-md transform -rotate-45"></div>
          ...
          {/* CTA Button moved below video for better mobile UX */}
          <div className="flex w-full justify-center mb-10">
            <button className="bg-[#AF8D4A] text-white font-medium py-3.5 px-8 rounded-md flex items-center justify-center transition-all duration-300 hover:bg-[#8C7239] shadow-lg shadow-[#AF8D4A]/20 w-full max-w-xs">
        ...
        {/* Icon features grid - Better grid for mobile */}
        <div className="w-full max-w-md">
          ...
          {/* Second row of icons for mobile */}
          <div className="grid grid-cols-2 gap-4 mt-6 mx-auto w-2/3">
            {/* Mindset Icon */}
            <div className="flex flex-col items-center text-center">
              <div className="text-[#AF8D4A] mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
